    ...
    *,
    ...
    return "\n".join(
        [
            ...
            "      --control-border: rgba(2, 6, 23, 0.14);",
            "    }",
            ...
            "    .controls label { display: flex; gap: 8px; align-items: center; color: var(--muted); font-size: 12px; }",
            "    .controls select {",
            ...
            "    .nav a:hover { color: var(--text); border-color: var(--control-border); background: var(--control-bg); }",
        ...
        "<body>",
            ...
            *[
            ...
            "  <script>",
            "    (function () {",
            "      var storageKey = 'vh_theme_preference';",
            ...
            "            tpl = resolved === 'dark' ? window.Plotly.Templates.plotly_dark : window.Plotly.Templates.plotly;",
            "          }",
            "          var paper = cssVar('--panel') || (resolved === 'dark' ? '#0f1a2e' : '#ffffff');",
            "          var bg = cssVar('--panel') || (resolved === 'dark' ? '#0f1a2e' : '#ffffff');",
            "          var text = cssVar('--text') || (resolved === 'dark' ? '#e6edf7' : '#0b1220');",
            "          var graphs = document.querySelectorAll('div.plotly-graph-div');",
            ...
            "      applyTheme(pref);",
            "      if (!window.Plotly) {",
            "        window.addEventListener('load', function () { applyTheme(select.value); });",
            "      }",
